...
#define MBED_CONF_APP_HOSTNAME                                                  "192.168.10.196"                                                                                 // set by application
#define MBED_CONF_APP_PORT                                                      "65431"                                                                                          // set by application
...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                   "ntueemakerspace"                                                                                // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                   WPA_WPA2                                                                                         // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                       "makerspace-2.4G"                                                                                // set by application[*]
